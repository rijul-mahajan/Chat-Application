...
public class ClientUI extends JFrame {
    ...
    private void setupUI() {
        setTitle("Elegant Chat - Connected as " + username);
        setSize(900, 600);
        ...
        JLabel titleLabel = new JLabel("Elegant Chat");
                ...
                try {
                    ...
                    while ((message = in.readLine()) != null) {
                        ...
                        SwingUtilities.invokeLater(() -> {
                            ...
                            if (finalMessage.contains("has joined the chat") || finalMessage.contains("has left the chat")) {
